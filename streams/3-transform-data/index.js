...
export const cleanup = () => {
  try {
      fs.rmSync('./books_written.csv');
      fs.rmSync('./books_stream.csv');
  } catch (err) {
...
export const withoutStream = async () => {
  ...
  /** Write out to a file */
  fs.writeFileSync('./books_written.csv', csv);
...
export const withStream = async () => {
   ...
   */
  const toFile = fs.createWriteStream('./books_stream.csv', { highWaterMark: 10_000 });
